...
- Repository service patterns: [services.md](services.md)
- Filter dependency catalog: [pagination.md](pagination.md)
- Channel pub/sub from SAQ workers: [websockets.md](websockets.md)
- App wiring with plugins: [plugins.md](plugins.md), [deployment.md](deployment.md)
