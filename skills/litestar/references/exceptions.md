...
- Repository services raise `NotFoundError` from `get` / `get_one`: [services.md](services.md)
- Validation errors from msgspec DTOs flow through Litestar's built-in handler unless you override: [dto.md](dto.md)
