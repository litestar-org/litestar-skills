...
| Redis | `redis` | `RedisService` | `redis_service`, `dragonfly_service` |
| Valkey | `valkey` | `ValkeyService` | `valkey_service` |
| Elasticsearch | `elastic_search` | `ElasticsearchService` | `elasticsearch_service` |
| Spanner | `spanner` | `SpannerService` | `spanner_service`, `spanner_connection` |
| BigQuery | `bigquery` | `BigQueryService` | `bigquery_service` |
